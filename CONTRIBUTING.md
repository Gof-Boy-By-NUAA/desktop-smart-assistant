# Contributing to SmartAssistant

Thanks for taking the time to contribute! 🎉 SmartAssistant is built by a global
...
Found a bug or have an idea? [Open an issue](https://github.com/zhayujie/SmartAssistant/issues/new/choose).
...
See the [Install from Source](https://docs.smart_assistant.ai/guide/manual-install)
guide. In short:

```bash
git clone https://github.com/zhayujie/SmartAssistant.git
cd SmartAssistant
...
Be respectful and constructive. We want SmartAssistant to be a welcoming place for
everyone.
