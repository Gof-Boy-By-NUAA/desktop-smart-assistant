...
class CowCliPlugin(Plugin):
    ...
    def _cmd_version(self, args: str, e_context, **_) -> str:
        return f"SmartAssistant v{__version__}"
    ...
    def _cmd_status(self, args: str, e_context: EventContext, session_id: str = "", **_) -> str:
        ...
        cfg = conf()
        lines = [_t("📊 SmartAssistant 运行状态", "📊 SmartAssistant Status"), ""]
    ...
    def _cmd_install_browser(self, args: str, e_context, **_) -> str:
        ...
        return _t(
            "✅ 安装流程已结束。请重启 SmartAssistant 后使用 browser 工具。",
            "✅ Installation finished. Restart SmartAssistant to use the browser tool.",
        )
    ...
    def _skill_list_remote(self, page: int = 1) -> str:
        ...
        lines.append(_t("🌐 https://skills.smart_assistant.ai  在线浏览全部技能", "🌐 https://skills.smart_assistant.ai  Browse all skills online"))
        return "\n".join(lines)
