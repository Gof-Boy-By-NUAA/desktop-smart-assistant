"""SmartAssistant CLI entry point."""
...
HELP_TEXT = """Usage: cow COMMAND [ARGS]...
  ...
  SmartAssistant CLI - Manage your SmartAssistant instance.

Commands:
  help     Show this message.
  version  Show the version.
  start    Start SmartAssistant.
  stop     Stop SmartAssistant.
  restart  Restart SmartAssistant.
  update   Update SmartAssistant and restart.
  status   Show SmartAssistant running status.
  logs     View SmartAssistant logs.
  skill    Manage SmartAssistant skills.
  knowledge  Manage knowledge base.
  backup   Back up config and agent workspace.
  restore  Restore a SmartAssistant backup.
