...
def run_install_browser(
    ...
    stream("")
    stream("Browser tool ready! Restart SmartAssistant to enable it.", "green")
    _phase(on_phase, _t(
        "🎉 全部步骤结束。请重启 SmartAssistant 后使用 browser 工具。",
        "🎉 All steps finished. Restart SmartAssistant to use the browser tool.",
    ))
    return 0
