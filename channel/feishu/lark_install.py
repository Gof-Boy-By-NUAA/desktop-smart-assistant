...
the desktop build (see zhayujie/SmartAssistant#2987 — "客户端没有飞书通道").
...
VENDOR_URLS = (
    ...
    "https://cdn.smart_assistant.ai/desktop/vendor/feishu-vendor-{version}.zip",
)

DOWNLOAD_TIMEOUT = 120

# Per-user, writable, persistent location. Mirrors the browser tool's ~/.cow
# layout so everything SmartAssistant owns lives under one roof.
