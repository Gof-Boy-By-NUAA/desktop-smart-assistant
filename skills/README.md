...
Browse, search, and install skills from [Cow Skill Hub](https://skills.smart_assistant.ai/).
...
2. **Custom skills** (higher): `./workspace/skills/` — installed via the skill manager or skill creator

Skills with the same name in the custom directory override builtin ones.

## Create & Contribute

See the [Skill Creation docs](https://docs.smart_assistant.ai/skills/create) for details, or submit your skill to [Skill Hub](https://skills.smart_assistant.ai/submit).
