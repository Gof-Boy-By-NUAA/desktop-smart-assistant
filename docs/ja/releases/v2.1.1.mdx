---
title: v2.1.1
description: SmartAssistant 2.1.1 - 自己進化、Web コンソールのメッセージ管理とマルチセッション並行、クロスプラットフォーム対応の MCP 強化、新モデルと改善
---
...
SmartAssistant に **自己進化（Self-Evolution）** が加わりました。Agent は単発のタスクをこなすだけでなく、日々の協働を通じて成長し続けます：
...
<img src="https://cdn.jsdelivr.net/gh/zhayujie/smart-assistant-assets@main/screenshots/en/web-console-evolution-demo.png" alt="自己進化の会話例" />

ドキュメント：[自己進化](https://docs.smart_assistant.ai/ja/memory/self-evolution)
...
ドキュメント：[MCP ツール](https://docs.smart_assistant.ai/ja/tools/mcp)
...
ソースコードでデプロイしている場合は `cow update` でワンクリックアップグレードするか、最新コードを取得して手動で再起動してください。詳細は [アップグレードガイド](https://docs.smart_assistant.ai/ja/guide/upgrade) を参照してください。

**リリース日**：2026.06.09 | [Full Changelog](https://github.com/zhayujie/SmartAssistant/compare/2.1.0...2.1.1)
