---
title: 手動インストール
description: SmartAssistantの手動デプロイ（ソースコード / Docker）
---
...
<Tip>
  ネットワークに問題がある場合は、ミラーを使用してください: https://gitee.com/zhayujie/SmartAssistant
</Tip>
...
| `agent_workspace` | Agent のワークスペースパス | `./workspace` |
...
<Tip>
  すべての設定オプションはプロジェクトの [`config.py`](https://github.com/zhayujie/SmartAssistant/blob/master/config.py) に記載されています。
</Tip>
