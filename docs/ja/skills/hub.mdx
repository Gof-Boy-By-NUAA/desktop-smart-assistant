...
[Cow Skill Hub](https://skills.smart_assistant.ai/) は、公式推奨・コミュニティ貢献・サードパーティ（GitHub、ClawHub など）のスキルを集約した、オープンソースの AI Agent スキルマーケットプレイスです。
...
- **ワンクリックインストール** — インストールコマンドをコピーして SmartAssistant で実行
...
1. [skills.smart_assistant.ai/submit](https://skills.smart_assistant.ai/submit) にアクセス
