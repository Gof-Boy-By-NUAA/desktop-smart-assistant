...
description: Export and restore SmartAssistant configuration and agent workspace data
---

SmartAssistant can create a portable local archive for migration or disaster recovery.
...
Stop SmartAssistant before restoring:
...
at the destination. When current SmartAssistant data exists, the command first
