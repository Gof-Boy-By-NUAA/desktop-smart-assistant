...
Skill management commands are used to install, query, and manage SmartAssistant skills. Use `/skill <subcommand>` in chat or `cow skill <subcommand>` in the terminal.
...
| `cowhub` | Installed from SmartAssistant Skill Hub |
