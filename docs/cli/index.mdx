...
description: SmartAssistant command system — Terminal CLI and chat commands
---

SmartAssistant provides two ways to interact via commands:
...
Service:
  start     Start the SmartAssistant service
  stop      Stop the SmartAssistant service
  restart   Restart the SmartAssistant service
