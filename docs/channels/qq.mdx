---
title: QQ Bot
description: Connect SmartAssistant to QQ Bot (WebSocket long connection)
---

> Connect SmartAssistant via QQ Open Platform's bot API, supporting QQ direct messages, group chats (@bot), guild channel messages, and guild DMs. No public IP required — uses WebSocket long connection.
