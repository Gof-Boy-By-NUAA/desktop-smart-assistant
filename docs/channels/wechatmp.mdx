...
description: Integrate SmartAssistant with WeChat Official Accounts
---

SmartAssistant supports both personal subscription accounts and enterprise service accounts.
