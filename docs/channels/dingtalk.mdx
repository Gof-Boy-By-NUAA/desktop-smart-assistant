---
title: DingTalk
description: Integrate SmartAssistant into DingTalk application
---

Integrate SmartAssistant into DingTalk by creating an intelligent robot app on the DingTalk Open Platform.
