---
title: WeCom
description: Integrate SmartAssistant into WeCom enterprise app
---

Integrate SmartAssistant into WeCom through a custom enterprise app, supporting one-on-one chat for internal employees.
