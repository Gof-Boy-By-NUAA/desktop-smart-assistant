---
title: v2.0.6
description: SmartAssistant 2.0.6 - Knowledge Base, Deep Dream Memory Distillation, Smart Context Compression, Web Console Multi-Session and More
---

## Project Renamed to SmartAssistant

The repository has been officially renamed from `chatgpt-on-wechat` to **SmartAssistant**, evolving into a full-featured AI Agent assistant.

- New URL: [github.com/zhayujie/SmartAssistant](https://github.com/zhayujie/SmartAssistant) — GitHub auto-redirects the old URL
...
Docs: [Knowledge Base](https://docs.smart_assistant.ai/en/knowledge)
...
Docs: [Deep Dream](https://docs.smart_assistant.ai/en/memory/deep-dream)
...
Docs: [Short-term Memory](https://docs.smart_assistant.ai/en/memory/context)
...
- **Vision optimization**: Image recognition tool prefers the primary model with automatic multi-provider fallback. Docs: [Vision Tool](https://docs.smart_assistant.ai/en/tools/vision)
...
**Release Date**: 2026.04.14 | [Full Changelog](https://github.com/zhayujie/SmartAssistant/compare/2.0.5...master)
