---
title: v2.1.0
description: SmartAssistant 2.1.0 - Internationalization, new Telegram / Discord / Slack / WeChat Customer Service channels, CLI interaction upgrades, MCP protocol enhancements and new models
---

🌐 [English](https://docs.smart_assistant.ai/releases/v2.1.0) | [中文](https://docs.smart_assistant.ai/zh/releases/v2.1.0)
...
- **Slack Bot**: Connect a Slack bot and bring SmartAssistant into your team's workflow
...
Documentation: [Channels Overview](https://docs.smart_assistant.ai/en/channels)

## 🌍 Internationalization

SmartAssistant introduces an end-to-end internationalization framework built for developers worldwide, adapting automatically based on the system language:
...
Documentation: [CLI Guide](https://docs.smart_assistant.ai/en/cli/general)
...
Documentation: [MCP Tools](https://docs.smart_assistant.ai/en/tools/mcp)
...
Documentation: [Models Overview](https://docs.smart_assistant.ai/en/models)
...
Source-code deployments can run `cow update` for a one-click upgrade, or pull the latest code and restart manually. See the [Upgrade Guide](https://docs.smart_assistant.ai/en/guide/upgrade) for details.

**Release Date**: 2026.06.01 | [Full Changelog](https://github.com/zhayujie/SmartAssistant/compare/2.0.9...2.1.0)
