---
title: v2.1.2
description: SmartAssistant 2.1.2 - Web Console management upgrades, Self-Evolution improvements, new models, WeCom smart-bot callback mode, and security hardening
---

🌐 [English](https://docs.smart_assistant.ai/releases/v2.1.2) | [中文](https://docs.smart_assistant.ai/zh/releases/v2.1.2)
...
Documentation: [WeCom Smart Bot](https://docs.smart_assistant.ai/channels/wecom-bot)
...
**Release Date**: 2026.06.18 | [Full Changelog](https://github.com/zhayujie/SmartAssistant/compare/2.1.1...2.1.2)
