---
title: v2.1.1
description: SmartAssistant 2.1.1 - Self-Evolution, Web Console message management and parallel sessions, cross-platform MCP enhancements, new models and improvements
---

🌐 [English](https://docs.smart_assistant.ai/releases/v2.1.1) | [中文](https://docs.smart_assistant.ai/zh/releases/v2.1.1)

## 🧬 Self-Evolution

SmartAssistant introduces **Self-Evolution**, letting the agent go beyond completing a single task and keep improving through everyday collaboration with you:
...
<img src="https://cdn.jsdelivr.net/gh/zhayujie/smart-assistant-assets@main/screenshots/en/web-console-evolution-demo.png" alt="Self-Evolution conversation example" />

Documentation: [Self-Evolution](https://docs.smart_assistant.ai/memory/self-evolution)
...
Documentation: [MCP Tools](https://docs.smart_assistant.ai/tools/mcp)
...
Documentation: [Models Overview](https://docs.smart_assistant.ai/models)
...
Source-code deployments can run `cow update` for a one-click upgrade, or pull the latest code and restart manually. See the [Upgrade Guide](https://docs.smart_assistant.ai/guide/upgrade) for details.

**Release Date**: 2026.06.09 | [Full Changelog](https://github.com/zhayujie/SmartAssistant/compare/2.1.0...2.1.1)
