---
title: v2.0.0
description: SmartAssistant 2.0 - Full upgrade from chatbot to AI super assistant
---

SmartAssistant 2.0 is a comprehensive upgrade from a chatbot to an **AI super assistant** — capable of autonomous thinking and task planning, long-term memory, operating computers, and creating and executing skills.

**Release Date**: 2026.02.03 | [GitHub Release](https://github.com/zhayujie/SmartAssistant/releases/tag/2.0.0)
...
Welcome to [submit feedback](https://github.com/zhayujie/SmartAssistant/issues) and [contribute code](https://github.com/zhayujie/SmartAssistant/pulls).
