---
title: v2.0.9
description: SmartAssistant 2.0.9 - Web Console model management, MCP protocol support, browser persistent login, new models and deployment hardening
---
...
<img width="720" alt="20260522113305" src="https://cdn.jsdelivr.net/gh/zhayujie/smart-assistant-assets@main/screenshots/en/web-console-models-config.png" />
...
Documentation: [MCP Tools](https://docs.smart_assistant.ai/en/tools/mcp). Thanks [@yangluxin613](https://github.com/yangluxin613) (#2801)
...
Documentation: [Browser Tool](https://docs.smart_assistant.ai/en/tools/browser). Thanks [@leafmove](https://github.com/leafmove) (#2809)
...
- **TTS rolls out to more channels**: Web Console, Personal WeChat, Feishu, DingTalk and WeCom Smart Bot all support voice replies — see the [Channels Overview](https://docs.smart_assistant.ai/en/channels)
...
**Release Date**: 2026.05.22 | [Full Changelog](https://github.com/zhayujie/SmartAssistant/compare/2.0.8...2.0.9)
