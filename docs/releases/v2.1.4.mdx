---
title: v2.1.4
description: "SmartAssistant 2.1.4: Desktop experience improvements, MCP OAuth authorization, Feishu channel enhancements, plus scheduler, data backup, and new models"
---

🌐 [English](https://docs.smart_assistant.ai/releases/v2.1.4) | [中文](https://docs.smart_assistant.ai/zh/releases/v2.1.4)
...
Docs: [Scheduled Tasks](https://docs.smart_assistant.ai/tools/scheduler)
...
Docs: [Feishu](https://docs.smart_assistant.ai/channels/feishu)
...
Docs: [Data Backup](https://docs.smart_assistant.ai/cli/backup)
...
- **Desktop client**: check for updates and update with one click inside the client, or get the latest version from the [download page](https://smart_assistant.ai/download/).

**Release date**: 2026.07.20 | [Full Changelog](https://github.com/zhayujie/SmartAssistant/compare/2.1.3...2.1.4)
