---
title: Architecture
description: SmartAssistant 2.0 system architecture and core design
---

SmartAssistant 2.0 has evolved from a simple chatbot into a super intelligent assistant with Agent architecture, featuring autonomous thinking, task planning, long-term memory, and skill extensibility.

## System Architecture

SmartAssistant's architecture consists of the following core modules:

<img src="https://cdn.jsdelivr.net/gh/zhayujie/smart-assistant-assets@main/architecture/en/architecture.png" alt="SmartAssistant Architecture" />
...
When Agent mode is enabled, SmartAssistant runs as an autonomous agent with the following workflow:
...
The Agent workspace is located at `./workspace` by default and stores system prompts, memory files, and skill files:
...
| `agent_workspace` | Workspace path | `./workspace` |
