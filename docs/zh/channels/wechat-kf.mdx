---
title: 微信客服
description: 将 SmartAssistant 接入微信客服（WeChat Customer Service）
---

通过把企业微信自建应用绑定到「微信客服」账号，SmartAssistant 可以接管来自外部微信用户的客服咨询，并可在小程序、公众号、视频号及视频号小店等场景中通过链接或二维码触达微信用户。
