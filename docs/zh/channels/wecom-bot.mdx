---
title: 企微智能机器人
description: 将 SmartAssistant 接入企业微信智能机器人（长连接模式）
---

> 通过企业微信智能机器人接入SmartAssistant，支持企业内部单聊和内部群聊，无需公网 IP，使用 WebSocket 长连接模式，支持Markdown渲染和流式输出。
