...
SmartAssistant 内置了 Skill Creator，可以通过自然语言对话快速创建、安装或更新技能。
...
3. 技能保存到工作空间的 `./workspace/skills/` 目录
...
<Tip>
  详细开发文档可参考 [Skill Creator 说明](https://github.com/zhayujie/SmartAssistant/blob/master/skills/skill-creator/SKILL.md)。
</Tip>
