...
[Cow Skill Hub](https://skills.smart_assistant.ai/) 是开源的 AI Agent 技能广场，汇集了官方推荐、社区贡献和第三方平台（GitHub、ClawHub 等）的技能。
...
- **一键安装**：复制安装命令即可在 SmartAssistant 中使用
...
1. 访问 [skills.smart_assistant.ai/submit](https://skills.smart_assistant.ai/submit)
