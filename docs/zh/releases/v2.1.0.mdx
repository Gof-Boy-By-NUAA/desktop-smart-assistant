---
title: v2.1.0
description: SmartAssistant 2.1.0 - 国际化支持、新增 Telegram / Discord / Slack / 微信客服通道、命令行交互升级、MCP协议增强、新模型接入
---
...
相关文档：[通道概览](https://docs.smart_assistant.ai/zh/channels)

## 🌍 国际化支持

SmartAssistant 引入全链路国际化框架，面向全球开发者，支持根据系统语言自动适配：
...
相关文档：[命令行指南](https://docs.smart_assistant.ai/zh/cli/general)
...
**发布日期**：2026.06.01 | [Full Changelog](https://github.com/zhayujie/SmartAssistant/compare/2.0.9...2.1.0)
