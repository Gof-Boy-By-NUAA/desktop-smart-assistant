 ...
 * pre-build backend source dir (build/dist/smart-assistant-backend, produced by
...
// Contents/Resources/backend/smart-assistant-backend (see extraResources).
const backendSrc = path.join(__dirname, 'build', 'dist', 'smart-assistant-backend')
const inAppPrefix = path.join('Contents', 'Resources', 'backend', 'smart-assistant-backend')
