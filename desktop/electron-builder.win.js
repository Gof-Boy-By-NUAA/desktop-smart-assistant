 ...
 * smart-assistant-backend.exe) and the NSIS installer. We deliberately do NOT add an
...
// includes the packaged backend (extraResources/backend/smart-assistant-backend.exe)
