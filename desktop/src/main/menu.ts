...
const DOCS_URL = 'https://docs.smart_assistant.ai'
...
export function buildAppMenu(getWindow: () => BrowserWindow | null) {
  ...
  const helpMenu: MenuItemConstructorOptions = {
    ...
    submenu: [
      ...
      { type: 'separator' },
      { label: 'Documentation', click: () => void openExternalSafely(DOCS_URL) },
      { label: 'Skill Hub', click: () => void openExternalSafely(SKILL_HUB_URL) },
    ],
  }
