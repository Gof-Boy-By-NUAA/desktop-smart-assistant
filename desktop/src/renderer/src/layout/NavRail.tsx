...
// language-agnostic.
const SKILL_HUB_URL = 'https://skills.smart_assistant.ai/'
// GitHub issues — where users report bugs / request features.
const FEEDBACK_URL = 'https://github.com/zhayujie/SmartAssistant/issues'

const websiteUrl = () => (getLang() === 'zh' ? 'https://smart_assistant.ai/zh' : 'https://smart_assistant.ai')
const docsUrl = () => (getLang() === 'zh' ? 'https://docs.smart_assistant.ai/zh' : 'https://docs.smart_assistant.ai')
...
const NAV_ITEMS: NavItem[] = [
  ...
  { path: '/delivery', labelKey: 'menu_delivery', icon: ClipboardCheck },
]
