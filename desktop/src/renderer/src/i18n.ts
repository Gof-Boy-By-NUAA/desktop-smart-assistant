const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    menu_logs: '日志',
    menu_logout: '退出登录',
    menu_forget_device_identity: '忘记本机身份',
    auth_forget_device_identity_confirm: '忘记本机身份会在下次登录时创建新的会话归属，且无法自动恢复当前历史。是否继续？',
    auth_forget_device_identity_error: '未能安全删除本机身份；已退出登录，但本机身份可能仍保留。',
    menu_models: '模型',
    menu_knowledge: '知识',
    menu_settings: '设置',
    menu_delivery: '交付验收',
    delivery_title: '交付与验收证据',
    delivery_desc: '只读查看发布门禁、正式报告和当前不可声明项。',
    delivery_loading: '加载交付证据中...',
    delivery_refresh: '刷新',
    delivery_passed: '所有当前门禁已通过',
    delivery_passed_desc: '证据链完整，可以进入客户验收。',
    delivery_blocked: '尚未达到交付边界',
    delivery_blocked_desc: '此页面不会把缺失证据转换为 PASS；请完成并独立验证列出的阻断条件。',
    delivery_manifest_absent: '发布证据清单不存在。',
    delivery_formal_gates: '正式门禁',
    delivery_reports: '报告状态',
    delivery_hard_denials: '不可声明清单',
    delivery_load_error: '交付证据加载失败',
    delivery_retry: '重试',
    delivery_invalid: '证据无效或响应不完整。',
    delivery_verification: '证据验证',
    delivery_integrity: '清单完整性验证',
    delivery_release_result: '交付结果',
    delivery_response_status: '响应状态',
    delivery_no_details: '没有可验证的明细；这不是 PASS。',
    delivery_stale: '过期',
    // knowledge
    knowledge_title: '知识库',
    ...
    knowledge_load_error: '知识库加载失败',
    knowledge_retry: '重试',
    knowledge_graph_error: '知识图谱加载失败，当前结果不可用。',
    ...
    menu_feedback: '反馈',
    // onboarding
    onboarding_welcome_title: '欢迎使用 SmartAssistant',
    ...
    session_rename: '重命名',
    session_delete: '删除',
    session_delete_confirm: '确定删除这个会话吗？此操作不可撤销。',
    session_empty: '暂无会话',
    session_load_error: '会话加载失败，请重试',
    session_retry: '重试',
    session_today: '今天',
    ...
    msg_edit: '编辑',
    msg_delete: '删除',
    msg_delete_confirm: '确定删除这条消息及其回复吗？此操作不可撤销。',
    msg_cancelled: '已中止',
    msg_cancel_requesting: '正在请求取消…',
    msg_cancel_unconfirmed: '取消未获确认，任务可能仍在运行。',
    msg_stream_interrupted: '流连接已中断，任务结果尚未确认；可点击停止再次请求取消。',
    msg_queued: '已排队，正在等待前序任务…',
    msg_queued_position: '已排队，第 {position} 位，正在等待前序任务…',
    ...
    chat_loading_history: '正在加载会话…',
    chat_history_failed: '会话记录加载失败，当前内容可能不完整。',
    chat_retry: '重试',
    chat_send: '发送',
    chat_attach: '添加附件',
    chat_upload_error: '附件上传失败',
    models_catalog_discovered: '供应商返回的模型目录；能力兼容性仍需验证。可填写自定义模型 ID。',
    models_catalog_builtin: '内置推荐目录；可填写自定义模型 ID，目录不限制可用模型。',
    models_catalog_failed: '模型发现失败，已保留内置推荐目录和自定义输入。',
    models_reasoning_only: '此模型始终开启思考；关闭深度思考时使用 low。模型可用性取决于账号与 API 地址。',
    slash_hint: '输入 / 查看命令',
    ...
    channels_empty_desc: '点击右上角「接入通道」按钮，即可将 SmartAssistant 接入微信、飞书、钉钉等消息通道',
    ...
    task_run_error: '执行失败',
    task_execution_unconfirmed: '上一次执行结果尚未确认；系统已阻止自动重试。',
    task_execution_running: '任务正在执行，或曾在中断时未完成确认；系统已阻止重复执行。',
    task_run_already_completed: '该请求此前已经完成',
    task_run_already_queued: '该请求已在执行中',
    logs_title: '日志',
    logs_desc: '实时日志输出 (run.log)',
    logs_live: '实时',
    logs_connecting: '日志流将在连接后显示...',
    logs_connecting_short: '连接中',
    logs_disconnected: '已断开',
    logs_unavailable: '日志流不可用，现有日志可能不是最新状态。',
    logs_retry: '重试',
    logs_last_event: '最后事件',
  ...
  en: {
    ...
    menu_forget_device_identity: 'Forget this device identity',
    auth_forget_device_identity_confirm: 'Forgetting this device identity creates a new session owner at the next login and cannot automatically restore this history. Continue?',
    auth_forget_device_identity_error: 'The device identity could not be safely removed. You were signed out, but the device identity may remain.',
    menu_models: 'Models',
    ...
    knowledge_load_error: 'Failed to load knowledge base',
    knowledge_retry: 'Retry',
    knowledge_graph_error: 'Knowledge graph failed to load; the current result is unavailable.',
    ...
    delivery_desc: 'Read-only view of release gates, formal reports, and current hard denials.',
    delivery_loading: 'Loading delivery evidence...',
    ...
    delivery_blocked_desc: 'Missing evidence is never converted to PASS here; complete and independently verify every blocker listed below.',
    delivery_manifest_absent: 'The release evidence manifest is absent.',
    delivery_formal_gates: 'Formal gates',
    delivery_reports: 'Report status',
    delivery_hard_denials: 'Hard denials',
    delivery_load_error: 'Failed to load delivery evidence',
    delivery_retry: 'Retry',
    delivery_invalid: 'Evidence is invalid or the response is incomplete.',
    delivery_verification: 'Evidence verification',
    delivery_integrity: 'Manifest integrity verification',
    delivery_release_result: 'Delivery result',
    delivery_response_status: 'Response status',
    delivery_no_details: 'No verifiable details are available; this is not a PASS.',
    ...
    // onboarding
    onboarding_welcome_title: 'Welcome to SmartAssistant',
    ...
    session_delete_confirm: 'Delete this conversation? This cannot be undone.',
    session_empty: 'No conversations yet',
    session_load_error: 'Failed to load conversations. Retry to try again.',
    session_retry: 'Retry',
    session_today: 'Today',
    ...
    msg_edit: 'Edit',
    msg_delete: 'Delete',
    msg_delete_confirm: 'Delete this message and its reply? This cannot be undone.',
    msg_cancelled: 'Cancelled',
    msg_cancel_requesting: 'Requesting cancellation?',
    msg_cancel_unconfirmed: 'Cancellation was not confirmed; the task may still be running',
    msg_stream_interrupted: 'Stream interrupted; task outcome is unconfirmed. Press Stop to request cancellation again.',
    msg_queued: 'Queued; waiting for the earlier task…',
    msg_queued_position: 'Queued at position {position}; waiting for the earlier task…',
    ...
    chat_loading_history: 'Loading conversation…',
    chat_history_failed: 'Conversation history failed to load; the current view may be incomplete.',
    chat_retry: 'Retry',
    chat_send: 'Send',
    chat_attach: 'Attach file',
    chat_upload_error: 'Attachment upload failed',
    models_catalog_discovered: 'Provider model catalog; capability compatibility still requires verification. Custom model IDs are accepted.',
    models_catalog_builtin: 'Built-in recommendations; custom model IDs are accepted. This is not an allowlist.',
    models_catalog_failed: 'Discovery failed. Built-in recommendations and custom input remain available.',
    models_reasoning_only: 'This model always reasons; disabling deep thinking uses low effort. Availability depends on your account and API endpoint.',
    ...
    channels_empty_desc: 'Click "Add channel" above to connect SmartAssistant to WeChat, Feishu, DingTalk and more',
    ...
    task_execution_unconfirmed: 'The previous execution result is unconfirmed; automatic retry is blocked.',
    task_execution_running: 'The task is running, or was interrupted before confirmation; duplicate execution is blocked.',
    task_run_already_completed: 'This request was already completed',
    task_run_already_queued: 'This request is already running',
    logs_title: 'Logs',
    logs_desc: 'Real-time log output (run.log)',
    logs_live: 'Live',
    logs_connecting: 'Log streaming will connect shortly...',
    logs_connecting_short: 'Connecting',
    logs_disconnected: 'Disconnected',
    logs_unavailable: 'The log stream is unavailable. Existing logs may be stale.',
    logs_retry: 'Retry',
    logs_last_event: 'Last event',
    ...
    login_network_error: 'Authentication service unavailable; check the connection and retry',
    auth_check_unavailable: 'Authentication status could not be confirmed. Access is blocked to protect your data; check the backend and retry.',
