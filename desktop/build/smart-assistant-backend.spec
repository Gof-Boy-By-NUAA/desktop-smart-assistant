...
"""
PyInstaller spec for the SmartAssistant desktop backend (onedir).

Produces a self-contained `smart-assistant-backend` folder that the Electron app
...
Build from the repo root:
    pyinstaller desktop/build/smart-assistant-backend.spec --noconfirm
"""
import os
...
# zhayujie/SmartAssistant#2987: "客户端没有飞书通道").
hiddenimports = [
...
# the box after a one-time fetch (fixes zhayujie/SmartAssistant#2987).
excludes = [
