...
available_setting = {
    ...
    # 技能影子检索只记录脱敏指标，不会把候选注入模型上下文。
    "skill_shadow_retrieval_enabled": False,
    "skill_shadow_retrieval_top_k": 5,
    # 生产技能检索默认关闭；开启后只注入复核通过的治理技能元数据。
    "skill_retrieval_injection_enabled": False,
    "skill_retrieval_injection_top_k": 5,
