...
from agent.tools.utils.governed_memory import is_machine_managed_path
...
class Edit(BaseTool):
    ...
    def execute(self, args: Dict[str, Any]) -> ToolResult:
        ...
        if is_machine_managed_path(absolute_path, self.cwd):
            return ToolResult.fail(
                "Error: machine-managed memory, knowledge, or governed skills must be changed through lifecycle tools"
            )
