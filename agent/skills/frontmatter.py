...
def parse_metadata(frontmatter: Dict[str, Any]) -> Optional[SkillMetadata]:
    ...
    # Unwrap nested namespace (e.g. {"openclaw": {...}} or {"smart_assistant": {...}})
...
_KNOWN_METADATA_NAMESPACES = {"smart_assistant", "openclaw"}


def _unwrap_metadata_namespace(metadata_raw: Dict[str, Any]) -> Dict[str, Any]:
    """
    Unwrap a single-key namespace wrapper like {"smart_assistant": {...} or {"openclaw": {...}}}.
